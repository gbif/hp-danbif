...
[![Build Status](https://builds.gbif.org/job/hp-danbif/badge/icon)](https://builds.gbif.org/job/hp-danbif/lastBuild/console)
...
# GBIF Hosted Portal: danbif

This Jekyll website, **[danbif (Staging)](https://danbif.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
